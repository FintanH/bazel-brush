...
-- * Capitalise Functions
--
-- $caps The set of functions on 'String' and 'T.Text' for capitalising a word.
...
codeNotInTheSameSection :: IO ()
codeNotInTheSameSection = print "Oh, hello!"
